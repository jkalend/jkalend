...
<!-- 🏳️‍⚧️ -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=28&duration=3000&pause=1000&color=5BCEFA&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=80&lines=Hey+there!+I'm+Andrea+%F0%9F%91%8B;Welcome+to+my+corner+of+GitHub+%E2%9C%A8" alt="Typing SVG" />
</p>

<p align="center">
  <img width="700" src="https://capsule-render.vercel.app/api?type=rect&color=gradient&customColorList=27&height=4" />
</p>
...
|---------|-------------|-------|
| 🧠 [**EEG Internet Addiction Detection**](https://github.com/jkalend) | Deep Learning pipeline for detecting internet addiction from brain signals using Transformers with convolutional layers & residual connections | `Python` `PyTorch` |
| 🔧 [**Custom CI/CD Pipeline Manager**](https://github.com/jkalend) | Local (but extensible) CI/CD pipeline manager with a full-stack interface | `Python` `TypeScript` `React` |
| 📦 [**Storehouse**](https://github.com/jkalend) | Kubernetes-based microservices storehouse system with gRPC communication | `Go` `Kubernetes` `gRPC` |
| 🤖 [**Nondeterministic Turing Machine**](https://github.com/jkalend) | Turing Machine simulator using BFS - accepts rules and validates input strings | `Prolog` |
| 🎹 [**Digital Piano Tone Synthesis**](https://github.com/jkalend) | DSP pipeline for analyzing and synthesizing piano tones from recorded samples | `Python` `Jupyter` |
| 🚀 [**SpaceX Mars Logistics Sim**](https://github.com/jkalend) | Discrete-event simulation of SpaceX Starship Mars supply chain operations | `C++` `Simlib` |
...
**Blockchain Research Assistant** @ [Security@FIT, BUT](https://www.fit.vut.cz/) *(Sep 2022 - Jul 2023)*
> Investigated DAG-chain based Kaspa cryptocurrency for vulnerabilities to specialized blockchain attacks. Explored its unique consensus protocol.

---

<p align="center">
  <img src="https://komarev.com/ghpvc/?username=jkalend&style=for-the-badge&color=5BCEFA&label=PROFILE+VIEWS" />
</p>
